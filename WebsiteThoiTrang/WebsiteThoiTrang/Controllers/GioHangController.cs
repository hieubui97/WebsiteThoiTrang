...
namespace WebsiteThoiTrang.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult ThemGioHang(int masp, string URL)
        {
            ...
            CHITIETSP giay1 = db.CHITIETSP.SingleOrDefault(n => n.MaSP == masp && n.MaMau == mau && n.MaSize == sizes);
            if (giay1 == null)
            {
            ...
            var slgiay = db.CHITIETSP.SingleOrDefault(n => n.MaSP == masp && n.MaMau == mau && n.MaSize == sizes).SoLuong;
        ...
        public ActionResult CapNhatGioHang(int masp, int mamau, int masize, FormCollection f)
        {
            ...
            var slgiay = db.CHITIETSP.SingleOrDefault(n => n.MaSP == masp && n.MaMau == mamau && n.MaSize == masize).SoLuong;
            if (kiemtra > slgiay)
            {
